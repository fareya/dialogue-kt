...
window_size = 3
INPUT_KEY = "teacher_move_type"
LABEL_KEY = "teacher_move_type"  # options: "teacher_move_type", "correctness_annotation"
...
def evaluate_model(model, test_loader, device):
    ...
    f1 = f1_score(all_labels, all_preds, average='weighted')  # or 'macro', 'micro' depending on your need

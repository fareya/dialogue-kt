...
def main():
    ...
    DATA_PATH = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/teacher_moves/processed_data/train_check3.jsonl"
    print(f"Using data: {DATA_PATH}")
    MODEL_NAME = "meta-llama/Llama-3.2-3B-Instruct"
    # MODEL_NAME = "meta-llama/Llama-3.2-3B-Instruct"
    print(f"Using model: {MODEL_NAME}")
    MODEL_SAVE_PATH = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/teacher_moves/model_llama32b_212"
...
def hyperparam_sweep():
    ...
    MODEL_NAME = "meta-llama/Llama-3.2-3B-Instruct"
    MODEL_SAVE_PATH = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/teacher_moves/model_llama32bv2_5"
    PRED_LABEL_NAME = "teacher_move_type"
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# The goal of this dataloader that differs it from other dataloaders is that instead
# of looking for the next teacher move, we are looking for the student move correctness 
...
def format_dialogue(data, pred_label_name, include_previous_turn_types=INCLUDE_PREV):
    formatted_outputs = []
    labels = [] 
    ids = [] 

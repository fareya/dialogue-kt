...
PROMPT_MATHDIAL = """Your task is to predict the next teacher move into one of four following categories: Focus, Probing, Telling, Generic. These four categories are described below.
- Focus:
...
def evaluate_multi_label_safe_2(y_true_raw, y_pred_raw):
    ...
    return {"accuracy": exact_match_acc, "f1_macro": f1_macro, "f1_micro": f1_micro, "f1_samples":f1_samples,"f1_weighted":f1_weighted, "total_samples":len(y_true)}
...
use_mathdial = True
pred_label = "future_teacher_move_type"
if use_mathdial:
    dataset = "MATHDIAL"
...
prompts_output_path = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/results/prompts"+"_"+ dataset +"_"+ pred_label +"_prev.jsonl"
...
results_output_path = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/results/prompts"+"_"+ dataset +"_"+ pred_label +"_prev.jsonl"
model = "gpt-4o"
batch_size = 10
...
if dataset == "ANATION":
   ...
   res = evaluate_multi_label_safe_2(extracted_ground_truth_labels, extracted_labels)
   print(res)
else: 
    f1 = f1_score(extracted_ground_truth_labels, extracted_labels, average='weighted')
    f1_macro = f1_score(extracted_ground_truth_labels, extracted_labels, average='macro')
    f1_micro = f1_score(extracted_ground_truth_labels, extracted_labels, average='micro')
    ...
    # res = compute_metrics(extracted_ground_truth_labels,extracted_labels)

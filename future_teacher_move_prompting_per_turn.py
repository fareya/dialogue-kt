...
formatted_outputs, labels, turn_ids = format_fn(grouped_data,pred_label, False)
...
results_output_path = "/work/pi_andrewlan_umass_edu/fikram_umass-edu/dialogue-kt/results/prompts"+"_"+ dataset +"_"+ pred_label +".jsonl"
model = "gpt-4o"
batch_size = 10
